...
// â”€â”€â”€ Signal kinds â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export const SIGNAL_KIND_ICON: Record<SignalKind, string> = {
  ...
  [SignalKind.Key]:       'â™­',
  [SignalKind.Groove]:    'â™©',
  [SignalKind.Feature]:   'â—ˆ',
  [SignalKind.Play]:      'â–¶',
  [SignalKind.Strum]:     'â™¾',
};

// â”€â”€â”€ Signal state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Signal types â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

// A generic chord signal â€” different targets interpret it differently:
...
// A key signal â€” carries the progression key (root + scale/mode).
...
// A groove signal â€” carries timing context from a metronome or backing track source.
...
export interface GrooveSignal extends BaseSignal {
  ...
  swing: number;   // 0.0â€“1.0; 0 = straight
  beat?: number;   // 0-indexed beat in measure; present during playback ticks
}

// A feature signal â€” carries a schedule interval's feature identity and config.
...
// A transport signal â€” carries play/stop state from a source to linked views.
...
// Strum action string union â€” mirrors StrokeAction enum values in strum_types.ts.
...
// â”€â”€â”€ SignalSink â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
