...
export interface NavButton {
  ...
  requiredInstruments?: InstrumentName[];
...
export const NAV_SECTIONS: NavSection[] = [
  {
    ...
    buttons: [
      ...
      },
      {
        ...
        requiredInstruments: [InstrumentName.Guitar],
      },
      {
        id: "multifret-feature",
        label: "MultiFret",
