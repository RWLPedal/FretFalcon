...
// ---------------------------------------------------------------------------
// Charango chord library (standard GCEAE tuning, 5 strings: G=0, C=1, E=2, A=3, E=4)
// ---------------------------------------------------------------------------
export const charango_chord_library: Record<string, Chord> = {
  // --- Major ---
  A_MAJOR: new Chord(
    "A",
    [2, 1, 0, 0, 0],
  ...
  C_MINOR: new Chord(
    ...
    [0, 3, 3, 3, 3],
    [0, 1, 1, 1, 1],
    [{ fret: 3, stringStart: 1, stringEnd: 4 }],
    CT.MINOR,
    N.C,
  ),
  D_MINOR: new Chord(
...
> = {
  ...
  [InstrumentName.Charango]: charango_chord_library,
...
export function getChordLibraryForInstrument(
